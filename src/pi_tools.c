...
void pi_iniImagens(SpriteSheet *sLapidesCruzes, SpriteSheet *sFantasmas, SpriteSheet *sGrama1,
					...
					SpriteSheet *sNevoa5, SpriteSheet *sNevoa6, SpriteSheet *sFumacas, SpriteSheet *sMontanhas, Icones *iPoderes,
...
//            printf("\nY:%0.1f", sLapidesCruzes->posY[counter]);
    ...
    /** configura montanhas **/
	sMontanhas->bitmap = al_load_bitmap("img/montanha/montanha.png");
    sMontanhas->x1         			= 0.0;
    sMontanhas->y1         			= 0.0;
    sMontanhas->largura    			= 1280;
    sMontanhas->altura     			= 720;
    sMontanhas->sheetSizeX 			= 1;
    sMontanhas->sheetSizeY 			= 1;
    sMontanhas->id 					= ID_MONTANHA;
    sMontanhas->repetirElementosX 	= 1;
    sMontanhas->repetirElementosY 	= 0;
    sMontanhas->novaAltura  		= -1;
    sMontanhas->novaLargura 		= -1;

	sMontanhas->colunaAtual		[0] = 0;
	sMontanhas->linhaAtual		[0] = 0;
    sMontanhas->posX			[0] = 0;
    sMontanhas->posY			[0] = telaJogo->altura - sMontanhas->altura - 10;
    sMontanhas->offsetX			[0] = 0;
    sMontanhas->offsetY			[0] = 0;
    sMontanhas->dirX			[0] = -1;
    sMontanhas->dirY			[0] = 1;
    sMontanhas->velX			[0] = 1.0;
    sMontanhas->velY			[0] = 0.0;
    sMontanhas->inicioY			[0] = sMontanhas->posY[0];
    sMontanhas->inicioX			[0] = telaJogo->largura;
    sMontanhas->fimY			[0] = sMontanhas->posY[0];
    sMontanhas->fimX			[0] = 0.0;
    sMontanhas->spriteId		[0] = counter;
    sMontanhas->loop			[0] = NAO;
    sMontanhas->profundidade	[0] = 0.1;
    sMontanhas->intervalo	 	[0] = 0;
    sMontanhas->contIntervalo	[0] = 0;
	sMontanhas->habilitado 		[0] = 1;
